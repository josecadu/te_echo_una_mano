...
<head>
    ...
    <title>{{ config('app.name', 'Te echo una mano') }}</title>
...
<body class="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat"
    ...
    <nav class="flex flex-col gap-4 items-center text-center">
        ...
        <a
            href="{{ route('login') }}"
            class="px-7 ml-7 py-2 text-black border border-black/70 rounded-full hover:bg-white/20 transition">
            ENTRAR
        </a>
        ...
        <a
            href="{{ route('register') }}"
            class="px-6 py-2 ml-7 text-black border border-black/70 rounded-full hover:bg-white/20 transition">
            REGISTRARSE
        </a>
        @endif
