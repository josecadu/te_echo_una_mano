                    ...
                    <x-dropdown align="right" width="60">
                        <x-slot name="trigger">
                            <span class="inline-flex rounded-md">
                                <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-grey-500 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-black transition ease-in-out duration-150">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            <span class="inline-flex rounded-md">
                                <button type="button"
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-xl text-gray-500 bg-yellow-300 hover:text-gray-700 hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 focus:text-gray-700 active:bg-yellow-300 transition ease-in-out duration-150">
                                    {{ Auth::user()->email }}
